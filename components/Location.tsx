...
const Location = () => {
  const locationsInfo: ILocationInfoProps[] = [
    ...
    {
      outletName: "Eastcon @ Karamunsing",
      address: "LG 41-48, Lower Ground Floor, Karamunsing Complex",
      contactNumber: "+6088240626 / 088247727",
      gMapsSrc:
